...
public class TodaysSummary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTodaysSummary.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(TodaysSummary.this,TansactionWiseHistory.class);
    ...
    {
        ConnectionDetector connectionDetector = new ConnectionDetector(TodaysSummary.this);
        if(connectionDetector.isConnectingToInternet()) {
            String tag_string_req = "string_req";

            final ProgressDialog pDialog = new ProgressDialog(TodaysSummary.this);
